  ...
  public function _get_default()
{
  ...
  $this->EUI_Page->_setFrom("t_gn_product_master a", TRUE);
 ...
 public function _get_content()
{
  ...
  // --------------- set query  --------------------------
	...
	$this->EUI_Page->_setArraySelect(array(
		...
		"IF(a.ProductStatusFlag=1, 'Active', 'Not Active') As StatusFlags" => array("StatusFlags", "Status")
		
	));
	
	$this->EUI_Page->_setFrom("t_gn_product_master a"); 
	$this->EUI_Page->_setJoin("t_gn_product_prefixnumber b", "a.ProductId=b.ProductId", "LEFT", true);
...
//   reset select ---------------------------
 ...
 $this->db->join("t_gn_product_prefixnumber b", "a.ProductId=b.ProductId", "LEFT");
 ...
 $this->db->from("t_gn_product_plan a ");		
 $this->db->where("a.ProductId", $ProductId);
 ...
 // ----------- nthen update --------------
	   ...
	   foreach( $arr_lbl as $key => $svf )
  {
	 ...
	 if( in_array( $val->get_value('index'), array('label') ))
	{
		...
		if( $this->db->update("t_gn_product_plan") ){
			$cond++;
		}
	}	
  }
