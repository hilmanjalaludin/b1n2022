...
<!-- wraplable -->
<div class="wraplable">
	<div class="paperworktitle">Detail Penawaran (PCTD)</div>
	<?php
    $this->load->form( sprintf("%s%s%s",  $folder, $subfolder, "form_penawaran"));
  ?>
</div>
...
<!-- <div class="wraplable">
	...
	<?php
    // $this->load->form( sprintf("%s%s%s",  $folder , $subfolder, "form_calculator"));
  ?>
</div> -->
