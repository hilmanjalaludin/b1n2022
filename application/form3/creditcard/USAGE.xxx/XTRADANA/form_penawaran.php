 ...
 <table class="paperworktable">
	...
	<tr> 
		...
		<?php echo form()->combo('TX_Usg_Programdata', 'select superlong', 
			ProgramDetail($Detail->field('TX_Usg_Penawaran','SetRealPercent')), $Detail->field('TX_Usg_Programdata')) ?> </td>
	</tr>
	...
	<tr> 
		<td class="ui-data-cell-1"><?php echo lang('Jumlah Dana');?></td>
		<td class="ui-data-cell-2"><?php echo form()->input('TX_Usg_JumlahDana', 'input_text tolong',
		$Detail->field('TX_Usg_JumlahDana',array('SetNominal','SetCurrency') ));?> </td>
	...
	<!--
		...
		<tr> 
			<td class="ui-data-cell-1"><?php echo lang('Calculator');?></td>
			<td class="ui-data-cell-2" colspan="3"><#?php echo form()->input('TX_Usg_Cabang', 'input_text tolong',
			$Detail->field('TX_Usg_Cabang'));?> </td>
		</tr>
	-->
