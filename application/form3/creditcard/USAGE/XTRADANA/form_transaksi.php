			...
			<tr>
				...
				<td class="ui-data-cell-1">
					<button name="btnEditXTradana" class="btn btn-success btn-xs button4" onclick="window.EditTrans(<?php echo $Newss->field('TX_Usg_TransSeq'); ?>);">
						...
						?>
							<button name="btnDeleteXTradana" class="btn btn-danger btn-xs button4" onclick="window.DeleteTrans(<?php echo $Newss->field('TX_Usg_TransSeq'); ?>, <?php echo $Newss->field('TX_Usg_Id'); ?>, <?php echo $Newss->field('TX_Usg_VerId'); ?>, <?php echo count($DetailTransaction);?> );">
