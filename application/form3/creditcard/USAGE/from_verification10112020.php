...
<?php  
	...
	if(is_array( $result_array )) 
		...
		if ($this->EUI_Session->_get_session('HandlingType') == 19) {
			printf(
				"<td><input type=\"text\" class=\"input_text tolong %s\" name=\"%s\" id=\"%s\" value=\"%s\" placeholder=\"\"> </td>",
				$form_input_name,
				$form_input_name,
				$form_input_name,
				$form_input_value
				...
				printf(
					"<td><input type=\"password\" class=\"input_text tolong %s\" name=\"%s\" id=\"%s\" value=\"%s\" placeholder=\"\"> </td>",
					$form_input_name,
					$form_input_name,
					$form_input_name,
					$form_input_value
