...
<div class="wraplable">
	<div class="paperworktitle">DATA PADA KARTU TAMBAHAN 1</div>
	<input type="hidden" class="FRM_ADDON_Id" name="FRM_ADDON_Id" value="<?php echo $Detail->get_value("TR_ADDONID"); ?>">
	<input type="hidden" class="CustomerNumber" name="CustomerNumber" value="<?php echo $CustomerNumber; ?>">
	<input type="hidden" class="FRM_ADDON_Ke" name="FRM_ADDON_Ke" value="1">
	...
	<table class="paperworktable">
		...
		<tr>
			...
			<td><input type="text" value="<?php echo $Detail->get_value("ADDON_Nama_Kartu"); ?>" class="input_text tolong" name="ADDON_Nama_Kartu_1" id="ADDON_Nama_Kartu_1" placeholder=""></td>

      <td>Hubungan</td>
			<td>
				<select type="combo" id="ADDON_Hubungan_1" class="select select-chosen" name="ADDON_Hubungan_1">
				<?php   
    ...
    <tr>
			<td>DOB</td>
			<td><input type="text" style="width:20%;" value="<?php echo $Detail->get_value("ADDON_Umur"); ?>" class="input_text" id="ADDON_Umur_1" name="ADDON_Umur_1" placeholder="">
      <input type="text" style="width:70%;" value="<?php echo $Detail->get_value("ADDON_DOB"); ?>" class="input_text tolong" id="ADDON_DOB_1" name="ADDON_DOB_1" placeholder=""></td>

      <td> Jenis Kartu</td>
			<td>
				<select type="combo" id="ADDON_Jenis_Kartu_1" class="select select-chosen" name="ADDON_Jenis_Kartu_1">
				<?php
    ...
    <tr>
      <td colspan="3">Jenis Kelamin</td>
			<td>
				<select type="combo" class="select select-chosen" name="ADDON_Jenis_Kelamin_1" id="ADDON_Jenis_Kelamin_1">
				<?php
					echo "<option value='0'>- PILIH -</option>";
