					...
					foreach ($result_array as $row_array) {
						...
						printf(
							"<div class=\"table-cell-content-extend table-cell-content center\">	
								<div class=\"ui-widget-form-table\" style=\"width:99%%;margin-top:-2px;\">
									<div class=\"ui-widget-form-row\">
										<div class=\"ui-widget-form-cell\"><button class=\"btn btn-default btn-xs field-after-verifikasi field-after-state button_%s\" id=\"%s\" name=\"%s\" onclick=\"window.ActionPaperWork('%s','BALCON');\">
										<i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>&nbsp;BALCON</button> 
										%s
										</div>
									</div>
								</div>
