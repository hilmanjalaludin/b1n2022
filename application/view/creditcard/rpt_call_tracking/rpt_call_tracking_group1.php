 	...
 	<form name="frmReport">
		<div class="ui-widget-form-table-compact">
			...
			<div class="ui-widget-form-row">
				...
				<div class="ui-widget-form-cell"><?php echo form()->combo('report_type','select auto', $report_type,null, array("change" => "ShowFilterReport(this);"));?></div>
			</div>
			...
			<div id="ui-widget-row1" class="ui-widget-form-row">
				...
				<div class="ui-widget-form-cell" id="ui-widget-content-row1">
					<?php echo form()->combo('ManagerId','select tolong',$report_manager, 
																		 $report_user->get_value('act_mgr'), 
																		 array("change"=>"ShowSpvReportByManger(this);"));?> </div>
			</div>
			...
			<div id="ui-widget-row6" class="ui-widget-form-row">
				...
				<div class="ui-widget-form-cell" id="ui-widget-content-row6"><?php echo form()->combo('interval','select auto', $report_mode);?></div>
			</div>
			...
			<div id="ui-widget-row7" class="ui-widget-form-row">
				...
				<?php echo form()->button_role( '_XLS_TOOL_', $report_button);?> -->
					...
					<?php echo form()->button('','page-go button','Show',array("click"=>"new ShowReports();"));?>
						<?php echo form()->button('','excel button','Export',array("click"=>"new ShowExcels();"));?>
