...
<input name="enddate" id="enddate2" class="input_text enddate date" value="" type="text">
		...
		<tr>
			<td class="text_caption"></td>
			<td>
 <input id="Show" value="Show Daily" form-name="reportdailyqa" class="page-go button" type="button">				 
 <input id="Export" value="Export Daily" form-name="reportdailyqa" class="excel button" type="button">
 <br>
 <input id="ShowDetails" value="Show Details" form-name="reportdailyqa" class="page-go button" type="button">
 <input id="ExportDetails" value="Export Details" form-name="reportdailyqa" class="excel button" type="button">
