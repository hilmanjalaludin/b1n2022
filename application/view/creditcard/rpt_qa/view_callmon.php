...
<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:
 ...
 <tr class=xl843954 height=17 style='mso-height-source:userset;height:12.95pt'>
  ...
  <td rowspan=2 class=xl783954 style='width:200'>Point of error</td>
  ...
  <td rowspan=2 class=xl813954 style='width:400'>Remaks Suspend</td>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.95pt'>
  ...
  <?php // Score Courtesy 
		$Approve_Status = $this->M_ReportQa->FirstMonitoring( $gcm->IdCustomer , "ApproveStatus" );
		$Remarks = $this->M_ReportQa->FirstMonitoring( $gcm->IdCustomer , "Remarks" );
  ?>
  ...
  <td class=xl713954 style='border-top:none;border-left:none'><?= $gcm->POE ;?></td>
  <td class=xl713954 style='border-top:none;border-left:none'><?= $this->M_ReportQa->getScore( $QuestionValue , "39-43" ); ?></td>
  <td class=xl713954 style='border-top:none;border-left:none'><?= $this->M_ReportQa->getDuration( $gcm->IdCustomer ); ?></td>

  <td class=xl713954 style='border-top:none;border-left:none'><?= $gcm->TotalPremi ;?></td>


  <td class=xl713954 style='border-top:none;border-left:none'><?php if ( $Approve_Status == 15 or $Approve_Status == 16 ) echo 1;  ?></td>
  <td class=xl743954 style='border-top:none;border-left:none'><?php if ( $Approve_Status == 11 ) echo 1;  ?></td>
  <td class=xl713954 style='border-top:none;border-left:none'><?php if ( $Approve_Status == 19 ) echo 1;  ?></td>
  <td class=xl713954 style='border-top:none;border-left:none'><?php if ( $Approve_Status == 12 ) echo 1;  ?></td>

  <?php 
	if ( $Approve_Status == 11 OR 
		 $Approve_Status == 19 OR	
		 $Approve_Status == 12 ) {
		$reasonstatus = $this->M_ReportQa->getRemarks( $gcm->IdCustomer , $Approve_Status );
	} else {
		$reasonstatus = '';
	}
  ...
  <td class=xl753954 width=60 style='border-top:none;border-left:none;width:45pt'><?= $reasonstatus; ?></td>
