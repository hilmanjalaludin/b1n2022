...
var objPage = {
  ...
  * @return [type]             [description]
  */
var Role = new Ext.Role("Rekontest");
	Role.extend([
...
window.UnderCallStatus = function( data ){
	...
	var datURL = Ext.EventUrl( new Array('Rekontest', 'CallReasonId') ).Apply(),
...
window.ToEventCallStatus = function( option ){
	...
	var datURL = Ext.EventUrl( new Array('Rekontest', 'CallReasonDataId') ).Apply(),
