<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array("Call Category ID"));?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("torek_callstatusid", "select tolong", AllCallStatusRekontest(), null, array('change' => 'window.ToEventCallStatus(this);')  );?></div>
		</div>
