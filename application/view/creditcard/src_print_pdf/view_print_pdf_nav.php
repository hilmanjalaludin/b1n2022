...
var Role = new Ext.Role("SrcPrintPdf");
	Role.extend([
 ...
 Ext.DOM.datas =
{
 ...
 wpdf_call_category 	: "<?php echo _get_exist_session('wpdf_call_category');?>",
 wpdf_call_end_date 	: "<?php echo _get_exist_session('wpdf_call_end_date');?>",
 wpdf_call_start_date 	: "<?php echo _get_exist_session('wpdf_call_start_date');?>",
 wpdf_call_status 		: "<?php echo _get_exist_session('wpdf_call_status');?>",
 wpdf_campaign_id 		: "<?php echo _get_exist_session('wpdf_campaign_id');?>",
 wpdf_cust_id 			: "<?php echo _get_exist_session('wpdf_cust_id');?>",
 wpdf_cust_name 		: "<?php echo _get_exist_session('wpdf_cust_name');?>",
 wpdf_cust_source 		: "<?php echo _get_exist_session('wpdf_cust_source');?>",
 wpdf_user_agent 		: "<?php echo _get_exist_session('wpdf_user_agent');?>",
 ...
 <form name="FrmCustomerCall">
	<div class="ui-widget-form-table-compact">
		<div class="ui-widget-form-row baris-1">
			...
			<div class="ui-widget-form-cell text_caption left"><?php echo form() -> combo('wpdf_campaign_id','select tolong', Campaign(), _get_exist_session('wpdf_campaign_id'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang('Customer ID');?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell left"><?php echo form() -> input('wpdf_cust_id', 'input_text tolong',_get_exist_session('wpdf_cust_id')) ?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Call Category'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form() -> combo('wpdf_call_category','select tolong', OutboundCategory(), _get_exist_session('wpdf_call_category'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang('Agent ID');?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell left"><?php echo form() -> combo('wpdf_user_agent','select tolong',User(), _get_exist_session('wpdf_user_agent'));?></div>
		</div>
		
		<div class="ui-widget-form-row baris-2">
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Recsource'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form() -> combo('wpdf_cust_source','select tolong', Recsource(),  _get_exist_session('wpdf_cust_source'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Customer Name'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell left"><?php echo form() -> input('wpdf_cust_name','input_text tolong', _get_exist_session('wpdf_cust_name'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Call Status'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form() -> combo('wpdf_call_status','select tolong', CallResultPrintPdf(), _get_exist_session('wpdf_call_status'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Call','Date'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form()->interval("wpdf_call", "input_text date","wpdf_call"); ?></div>
