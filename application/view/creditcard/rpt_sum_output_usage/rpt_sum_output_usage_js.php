...
// edit 20112020
	...
	//2021-11-29
	Ext.DOM.ShowReportPplus = function()
	{
		// alert('start');
		var supervisor	= Ext.Cmp('supervisor_pplus').getValue();
		var start_date	= Ext.Cmp('start_date_pplus').getValue();
		var end_date	= Ext.Cmp('end_date_pplus').getValue();
		...
		if(start_date == "" || end_date == "") {
			...
			Ext.Window
			({
				url 	: Ext.DOM.INDEX +'/RptSumOutputPplus/ShowReport',
				param 	: {
	...
	Ext.DOM.ShowExcelPplus = function()
	{
		var supervisor	= Ext.Cmp('supervisor_pplus').getValue();
		var start_date	= Ext.Cmp('start_date_pplus').getValue();
		var end_date	= Ext.Cmp('end_date_pplus').getValue();
		...
		if(start_date == "" || end_date == "") {
			...
			Ext.Window
			({
				url 	: Ext.DOM.INDEX +'/RptSumOutputPplus/ShowExcel',
				param 	: {
					supervisor : supervisor,
					start_date : start_date,
					end_date : end_date
