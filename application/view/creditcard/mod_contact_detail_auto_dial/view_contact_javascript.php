    ...
    */
    ...
    // lepas aja ya
    var callDataResponse = 0, row = Ext.Json('SrcCustomerList/SetFollowup', {
    ...
    */
    ...
    Ext.ShowMenu( new Array('SrcCustomerListAutoDial','ContactDetail'),
    ...
    */
    ...
    console.log('Calling Number = '+Ext.Cmp("CallingNumber").getValue());
    console.log('Customer Id = '+Ext.Cmp("DM_Id").getValue());
    ...
    */
    ...
    isNext = window.setTimeout(function(){ 
        window.EventNext(); 
    }, 3000);
    } else{
    ...
    */
    ...
    window.SetNumber = function( data ) {
        var str = Ext.BASE64.decode(data);
        console.log(str);
        var datacall = str.split("-");
        console.log(datacall[1]);
        Ext.Cmp('CallingNumber').setValue(datacall[1]);
    }
