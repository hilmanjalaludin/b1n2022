...
<table>
	...
	if ( $data_ntb != false ) {
		...
		foreach ( $data_ntb->result_array() as $dn ) {
			...
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("DB_SourceAgentID") . "</td>";
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("DB_Nama_KTP") . "</td>";
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("CC_Nama_Yang_Diinginkan") . "</td>";
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("DB_DOB") . "</td>";
			...
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("EC_Hubungan") . "</td>";
			...
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("CONTACT_Status_Tempat_Tinggal") . "</td>";
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("CONTACT_Status_Tempat_Tinggal_Other") . "</td>";
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("CONTACT_Status_Pernikahan") . "</td>";
			...
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("CONTACT_Tempat_Lahir") . " / " . $obj_ntb->get_value("CONTACT_Tgl_Lahir") . "</td>";
			...
			$row_data_ntb .= "<td>" . $obj_ntb->get_value("WORK_Jenis_Perusahaan") . "</td>";
	...
	<tr>
		...
		if ( is_array($data_ntb_dualcard) AND $count_data_dualcard > 0 ) {
			...
			foreach ( $data_ntb_dualcard as $number_dual_card => $ddc ) {
				...
				echo "<td>" . $dc_obj->get_value("MotdersName") . "</td>";
