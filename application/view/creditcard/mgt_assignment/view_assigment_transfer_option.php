...
<fieldset class="corner ui-fieldset-trans-bottom" style="width:auto;margin:5px; border-radius:5px;">
<?php echo form()->legend(lang(array("Option","Transfer")),"fa-gear");?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("trans_user_type", "select xselect tolong", DistribusiType(), null);?></div>
		</div>
		...
		<!-- <div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php //echo form()->combo("trans_to_user_group", "select xselect tolong", DitributeUserLevel(), null, array("change" => "Ext.DOM.SelectUserTransToByGroup(this);"));?></div>
		</div> -->

		<!--  Dropdown New UserLevelTransfer 30/08/2018-->
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Trans. To Group");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("trans_to_user_group", "select xselect tolong", TransferUserLevel(), null, array("change" => "Ext.DOM.SelectUserTransToByGroup(this);"));?></div>
		</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("trans_user_mode", "select xselect tolong", DitributeMode());?></div>
		</div>
