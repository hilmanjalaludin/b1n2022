...
if( window.LEVEL.USER_UPLOADER == Ext.Session('HandlingType').getSession() ){
	...
	/**
	var EXTTITLE  = [['Back'],['Find'],[],[],[],[],['By CheckList'],['By Amount']],
		EXTMENU   = [['backtohome'],['FindBucket'],[],[],[],[],['Ext.DOM.DistribueByChecklist'],['Ext.DOM.ProcessAmount']],
	...
	<form name="frmBucketData">
		...
		<div class="ui-widget-form-table-compact">
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left"><?php echo form()->combo('bucket_assign_recsource','select superlong', Recsource() ,_get_exist_session('bucket_assign_recsource')); ?></div>
			...
			<div class="ui-widget-form-row baris-1">
				...
				<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Upload Date'));?></div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				...
				<div class="ui-widget-form-cell text_caption"><?php echo lang(array('Assign Status'));?></div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell left"><?php echo form()->combo('bucket_assign_status','select superlong',array('0' => 'NO','1' => 'YES'),_get_exist_session('bucket_assign_status')); ?></div>
