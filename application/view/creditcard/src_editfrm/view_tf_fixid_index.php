...
<?php get_view(array("src_editfrm","view_tf_fixid_jsv"));?>
<div id="ui-widget-user-tf-fixid" class="tabs corner ui-frame-with">
	...
	<!-- start content data ------>
	<div id="ui-widget-tf-fixid-cm"><?php get_view(array("src_editfrm","view_tf_fixid_cm"));?></div>	
	<!-- <div id="ui-widget-tf-fixid-cv"><?php// get_view(array("src_editfrm","view_tf_fixid_cv"));?></div> -->
