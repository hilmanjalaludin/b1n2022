...
// --------- start var date time 	--------------------------
	...
	$start_date = $out->field('start_date', 'SetDate');
	$end_date = $out->field('end_date', 'SetDate');
 ...
 function _select_report_agent_time()
{
	...
	$sql = sprintf("select 
			...
			a.agent_busy,
			a.agent_acw
			from t_gn_agent_activity_report  a ,  tms_agent b ,cc_agent c
...
<html>
	<head>
		<title><?php echo title_header("Call Tracking - Summary Time Agent");?></title> 
