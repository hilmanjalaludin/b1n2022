	...
	<div id="ui-widget-add-content" class="ui-widget-add-content ui-frame-with">
	 ...
	 <fieldset class="corner ui-widget-fieldset" style="margin:5px; border-radius:5px;">
		...
		<form name="frmEditLayout">
			<input type="hidden" id="TgnLayoutId" name="TgnLayoutId" value="<?php echo $LayoutData->get_value('Id');?>"/>
			<table cellpadding="8px" cellspacing="8px">
				<tr>
					<td class="text-caption">Layout Themes </td>
					<td class=""><?php echo form() -> combo('UserThemes','select superlong',$UserThemes,$LayoutData->get_value('Themes'));?></td>
				</tr>
				<tr>
					<td class="text-caption">Layout Name</td>
					<td class=""><?php echo form() -> combo('UserLayout','select superlong', $UserLayout,$LayoutData->get_value('LayoutId') );?></td>
				</tr>
				<tr>
					<td class="text-caption">User Group</td>
					<td class=""><?php echo form() -> combo('UserGroup','select superlong',$UserGroup,$LayoutData->get_value('GroupId') );?></td>
				</tr>
				<tr>
