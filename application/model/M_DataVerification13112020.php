...
function _select_ver_master( $CustomerId ){
	...
	WHERE mc.VH_Data_CustId=107 AND mc.VH_Data_Name='DM_MotherName' AND  mc.VH_Data_VerStatus=0) AS total_failed, 
	(SELECT count(mc.VH_Data_Value) FROM t_gn_verification_history mc 
	WHERE mc.VH_Data_CustId=107 AND mc.VH_Data_Name='DM_MotherName' AND  mc.VH_Data_VerStatus=1 )AS total_benar, a.*,c.VH_Data_VerStatus,cv.CV_Data_VerficationStatus ,b.DM_MotherName from t_gn_verification_setup a
