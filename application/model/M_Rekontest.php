...
/**
  ...
  */
class M_Rekontest extends EUI_Model{
...
// inull then get default ----------------
 ...
 $this->db->where( sprintf("c.CampaignEndDate>='%s'", date('Y-m-d')), "", FALSE);
  ...
  if( $this->out->find_value('frmrek_from_recsource') ){
	$this->db->where_in("b.DM_Recsource", $this->out->fields('frmrek_from_recsource'));
 }
