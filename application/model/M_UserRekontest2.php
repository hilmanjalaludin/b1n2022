...
/**
  ...
  */
class M_UserRekontest2 extends EUI_Model
{
...
/**
 ...
 function __construct() { 
	$this->load->model(array('M_Rekontest2','M_SysUser'));
 }
...
/**
  ...
  * @return [type]             [description]
  */
 function _set_row_rekontest2_perrata( $out = null )  {
//	 debug($out);
  
// call object --
 $objRek = Singgleton( 'M_Rekontest2' );
 $rowAsg = array();
...
// ------ get on DB  
 if( $out->get_value('trans_user_action') == 1 ){
	$rowAsg = $objAsg->_select_page_transfer( $out, array(
		"a.AssignId",
