...
/**
 ...
 // check validation data .
	...
	var	row = Ext.Json('DataVerification/VerificationIdentify_balcon', {
	...
	row.dataItemEach( function( row, xhr ){
		...
		console.log('verifyDataJsonServer 77', verifyDataJsonServer)
	});
 } 

//  window.VerificationIdentify_balcon = function(){
//  // sent data to server for request confirm proces 
//  // check validation data .
// 	var CustomerId  = Ext.Cmp('CustomerId').getValue(), // cross ID::<view:?/*_contact_detail/>
// 		CampaignId  = Ext.Cmp('CampaignId').getValue(), // cross ID::<view:?/*_contact_detail/>
...
// ambil id nya dan cari di json data 
	...
	//console.log('verifyDataJsonServer',verifyDataJsonServer[rowDataJsonClientID]); 
	...
	var rowDataJsonClientID = dataClientMaster.id,
		...
		// alert('ok');
		// return false;
		// console.log('disini undefined',rowDataJsonServer = verifyDataJsonServer[rowDataJsonClientID]);
		// return false;
	if( typeof( rowDataJsonServer ) == 'object' ){
		console.log('obhect 1');
		...
		// alert( rowDataVerificationSuccess);
		// return false;
...
// get customer ID from Cross ID .	
	...
	// console.log('test',dataPaperWork);
...
/**
 ...
 window.VerifikasiMasterConsole = function(){
	...
	// yang di verifikasi. 
	 ...
	 console.log(dataServerMasterStore,'dataServerMasterStore');
	 if( typeof( dataServerMasterStore ) == 'object' )  {
		 ...
		 // looping data rekursive .
		  for( var key in dataServerMasterStore ) {
			 ...
			 console.log(dataJsonRow,'dataJsonRow'+key)
