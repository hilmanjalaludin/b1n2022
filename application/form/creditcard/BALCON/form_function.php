 ...
 */	 
 ...
 if( !function_exists('DaftarKartu') ) {
	function DaftarKartu(){
		$VR = Verifikasi();
		return $VR->_select_ver_row( UR()->field('CustomerId') );
	}
 }
 /**
 * [RouteForm description]
 ...
 */	 
 ...
 if( !function_exists('DataMaster') ) {
	function DataMaster(){
		$VR = Verifikasi();
		return $VR->_select_ver_master(UR()->field('CustomerId'));
		// return $VR->_select_ver_master(0);
	}
 }

 if( !function_exists('DataMaster_balcon') ) {
	function DataMaster_balcon(){
		$VR = Verifikasi();
		return $VR->_select_ver_master_balcon(UR()->field('CustomerId'));
		// return $VR->_select_ver_master(0);
	}
 }
 /**
