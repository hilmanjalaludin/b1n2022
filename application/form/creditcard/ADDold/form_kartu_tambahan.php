...
<div class="wraplable">
	<div class="paperworktitle">DATA PADA KARTU TAMBAHAN</div>
	...
	<table class="paperworktable">
		...
		<tr>
			...
			<td><input type="text" value="<?php echo $Detail->get_value("ADDON_Nama_Kartu"); ?>" class="input_text tolong" name="ADDON_Nama_Kartu" placeholder=""></td>

      <td>Hubungan</td>
			<td>
				<select type="combo" id="ADDON_Hubungan" class="select select-chosen" name="ADDON_Hubungan">
				<?php   
    ...
    <tr>
			<td>DOB</td>
			<td><input type="text" style="width:20%;" value="<?php echo $Detail->get_value("ADDON_Umur"); ?>" class="input_text" id="ADDON_Umur" name="ADDON_Umur" placeholder="">
      <input type="text" style="width:70%;" value="<?php echo $Detail->get_value("ADDON_DOB"); ?>" class="input_text tolong" id="ADDON_DOB" name="ADDON_DOB" placeholder=""></td>

      <td> Jenis Kartu</td>
			<td>
				<select type="combo" id="ADDON_Jenis_Kartu" class="select select-chosen" name="ADDON_Jenis_Kartu">
				<?php
    ...
    <tr>
      <td colspan="3">Jenis Kelamin</td>
			<td>
				<select type="combo" class="select select-chosen" name="ADDON_Jenis_Kelamin">
				<?php
					echo "<option value='0'>- PILIH -</option>";
    ...
    <tr>
      ...
      <td><input type="text" value="<?php echo $Detail->get_value("ADDON_No_Hp"); ?>" class="input_text tolong" id="ADDON_No_Hp" name="ADDON_No_Hp" placeholder=""></td>
    </tr>
