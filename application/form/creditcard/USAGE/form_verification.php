<table class="paperworktable">
	...
	foreach ($result_array as $row) {
		...
		if ($this->EUI_Session->_get_session('HandlingType') == 19) 
		{
			...
			if ($row->field('SV_Data_Field') == 'CV_Data_Usia') {
				printf(
					"<td><input type=\"text\" class=\"input_text tolong %s\" name=\"tahun_%s\" id=\"tahun_%s\" value=\"\" placeholder=\"Tahun\" style=\"width: 100px;\">",
					$form_input_name,
					$form_input_name,
					$form_input_name,
					$form_input_value
				...
				printf(
					"<input type=\"text\" class=\"input_text tolong %s\" name=\"bulan_%s\" id=\"bulan_%s\" value=\"\" placeholder=\"Bulan\" style=\"width: 50px;\"> </td>",
					$form_input_name,
					$form_input_name,
					$form_input_name,
					$form_input_value
