...
$config['base_layout'] 			= 'kawani';
$config['base_application'] 	= 'creditcard';
...
$autoload['helper']    = array(	'url','string','language', 'EUI_Common', 
								...
								'EUI_OleRead','EUI_Layout','EUI_Server','EUI_Version','EUI_Page','EUI_Dropdown', 'EUI_Cache', 'EUI_MasterIterator'
							);
