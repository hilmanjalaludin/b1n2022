...
class ExportExcelManual extends EUI_Controller
{
    ...
    function index()
    {
		...
		$judul = 'CALL HISTORY BNI 29-31 des 2020';
        $fileName = 'CALL_HISTORY_BNI_29-31_des_2020';
    ...
    function getData()
    {
        $start_date = "2020-12-29 01:00:00";
