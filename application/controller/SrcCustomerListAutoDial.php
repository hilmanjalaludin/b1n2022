...
class SrcCustomerListAutoDial extends EUI_Controller {
 /*
  * [Recovery data failed upload HSBC TAMAN SARI]
  * @param  [type] $CustomerId [description]
  * @return [type]             [description]
 ...
 function ContactDetail()
{
 ...
 $controller = "SrcCustomerList";
 // then call my object 
 
 $result_button = $rol->_select_role_form_action($controller);
 $result_detail = $std->_select_row_master_detail( $out->field('MasterDataId') );
 // load my view detail .
 
 $this->load->view('mod_contact_detail_auto_dial/view_contact_main_detail', array(
 ...
 function getAutoCustomer()
{
	...
	$Data = $this -> M_SrcCustomerListAutoDial -> _select_row_limit_data();
	// print_r($Data);
