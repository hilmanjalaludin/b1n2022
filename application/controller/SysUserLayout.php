 ...
 */
 ...
 function EditUserLayout()
 {
	...
	$sys = get_class_instance(base_class_model($this));
	if(_have_get_session('UserId') )
	{
		$data = array
		(
			'LayoutData' => new EUI_Object($sys->_getLayout( $out->get_value('LayoutId'))),
			'UserThemes' => $this->M_SysThemes->_getUserThemes(),
			'UserLayout' => $this->M_SysThemes->_getUserLayout(),
			'UserGroup'	 => $this->M_SysUser->_get_handling_type()	
		);
...
function UpdateLayout()
{
  ...
  $Lyt = & get_class_instance(base_class_model($this));
  $Con = $Lyt->_setUpdateLayout( new EUI_Object(_get_all_request()));
