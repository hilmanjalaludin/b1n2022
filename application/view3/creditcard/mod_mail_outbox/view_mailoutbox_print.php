		...
		<td>
			<table border=0 cellspacing=0 width='99%' cellpadding='3px;'>
				...
				<tr>
					...
					<td class='caption'>:</td>	
					<td class='content'><?php echo $content->get_value('EmailCreateTs');?></td>
				</tr>	
				
				<tr>
					<td class='caption'>Attachment</td>
					<td class='caption'>:</td>	
					<td class='content'><a href="<?php echo base_page(sprintf("MailOutbox/Download/Attachment/%s", $content->get_value('EmailOutboxId')));?>" target="_blank"><?php echo $content->get_value('attachment');?></a></td>
				</tr>	
			</table>
