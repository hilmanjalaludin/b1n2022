...
<?php  
if ( $status == "ExportDetails" ) {
	$filename = "ExportDetailsDailyQa".$startdate."-". $enddate;
...
?>
<title>Detail Summary Tanggal <?php echo $fromdate; ?></title>
</head>
...
<h2 class="xl6920135">Detail Summary Tanggal <?php echo $fromdate; ?></h2>
...
<table border=0 cellpadding=0 cellspacing=0 width=1328 class=xl6820135
 ...
 <tr class=xl6820135 height=33 style='mso-height-source:userset;height:25.15pt'>
  ...
  <td class=xl6620135 width=144 style='width:108pt'>Agent Name</td>
    <td class=xl6620135 width=144 style='width:108pt'>ATM Name</td>
 ...
 <?php 
	...
	if ( $detailPerDateSummary != false	) {
		...
		<tr class=xl6820135 height=33 style='mso-height-source:userset;height:25.15pt'>
		  ...
		  <td class=xl7020135 width=120 style='width:90pt'><?php echo str_replace(".", "," ,_getCurrency($dp->TotalPremi)); ?></td>
		  ...
		  <td class=xl7220135 width=121 style='width:91pt'><?php echo $dp->AgentName; ?></td>
		   <td class=xl7220135 width=121 style='width:91pt'><?php echo $dp->ATMName; ?></td>
...
if ( $dprs != false	) { ?>
Verified Selling : <?= $dprs->TotVerifiedSelling-1 ?> <br>
Verified Reconfirm : <?= $dprs->TotVerifiedReconfirm-1 ?> <br>
Suspend Data Edit :<?= $dprs->TotSuspendDataEdit-1 ?> <br>
Suspend Selling :<?= $dprs->TotSuspendSelling-1 ?> <br>
Declined Confirm : <?= $dprs->TotDeclineConfirm-1 ?> <br>
Declined Cancel : <?= $dprs->TotDeclineCancel-1 ?> <br>
Suspend Data Selling Confirm : <?= $dprs->TotSuspendDataSellingConfirm-1 ?> <br>
Suspend Data Selling Pending : <?= $dprs->SuspendDataSellingPending-1 ?> <br>
Suspend Still : <?= $dprs->TotSuspendStill-1 ?> <br>
<?php } else { echo 1; } ?>
