    ...
    <?php if ( $reportQaAll != "error" ) :  ?>
        ...
        <table class="tg" style="undefined;table-layout: fixed; width: 1218px">
          <tr>
            ...
            <th class="tg-9hbo">Suspend</th>
            <th class="tg-9hbo">Verified</th>
            <th class="tg-9hbo">Declined</th>
            <th class="tg-9hbo">Pending</th>
          </tr>
          ...
          <?php 
            ...
            if ( $reportperformanceqa != "error" ) { 
              ...
              <tr>
                ...
                <td class="tg-yw4l"><?= _getDuration($rpq->totalDuration); ?></td>

                <td class="tg-yw4l"><?= $rpq->Suspend; ?></td>
                <td class="tg-yw4l"><?= $rpq->Verified; ?></td>
                <td class="tg-yw4l"><?= $rpq->Declined; ?></td>
                <td class="tg-yw4l"><?= $rpq->Pending; ?></td>
              </tr>
                ...
                ?>
                  <tr class="totalAll">
                    ...
                    <td class="tg-yw4l"><?= _getDuration($rpqs->totalDuration); ?></td>
					<td class="tg-yw4l"><?= $rpqs->Suspend; ?></td>
                    <td class="tg-yw4l"><?= $rpqs->Verified; ?></td>
                    <td class="tg-yw4l"><?= $rpqs->Declined; ?></td>
                    <td class="tg-yw4l"><?= $rpqs->Pending; ?></td>
                  </tr>
               <?php } ?>
                
             <?php } else { ?>
              <tr >
                <td colspan='14' class="tg-yw4l">Data Not Available</td>
              </tr>
            <?php } ?>
