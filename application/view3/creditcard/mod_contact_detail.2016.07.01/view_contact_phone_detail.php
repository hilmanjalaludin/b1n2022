 ...
 <?php echo form()->hidden("CallingNumber",NULL, $Detail->get_value('CustomerMobilePhoneNum')); ?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center">:</div>
			<div class="ui-widget-form-cell" id="DivCallResultId">
			<?php echo form()->combo('CallResult','select tolong select-chosen ',EventUserStatusCall(_get_session('HandlingType'), $Detail), $Detail->get_value('CallReasonId'),array('change'=>'getEventSale(this);')); ?> </div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell">
				...
				<?php echo form()->combo('hour_call_later','select boox select-chosen',ListHour(), '00', null,array('style'=>'width:52px;margin-top:2px;')); ?> :
				<?php echo form()->combo('minute_call_later','select boox select-chosen',ListMinute(),'00', null, array('style'=>'width:52px;margin-top:2px;'));?>
			</div>
		</div>
		...
		<!--
		<div class="ui-widget-form-row baris1">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Create POD");?></div>
			<div class="ui-widget-form-cell center">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->writepod("frm_create_pod", NULL, $Detail->get_value('CustomerId'), array("change" => "window.EventCreatePod(this);"), $Detail);?></div>
		</div>
		-->
		<div class="ui-widget-form-row baris1">
