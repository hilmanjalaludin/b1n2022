...
<script>
	...
	Ext.document(document).ready(function()
	{
		...
		Ext.DOM.ShowReport = function() 
		{
			...
			Ext.Window({
				url 	: Ext.DOM.INDEX +'/RawDataReport/ShowReport/',
				param 	: {
		...
		Ext.DOM.ShowExcel = function()
		{
			Ext.Window
			({
				url 	: Ext.DOM.INDEX +'/RawDataReport/ShowExcel/',
				param 	: { 
					start_date : Ext.Cmp('start_date').getValue(), 
					end_date : Ext.Cmp('end_date').getValue(),
					mode : Ext.Cmp('ModeBy').getValue(),
		...
		Ext.Ajax
		({
			url 	: Ext.DOM.INDEX +'/RawDataReport/getCampaign/',
			param 	: {
...
<div id="panel-main-content">
	<table border=0 width='100%'>
		<tr>
			<td width='40%' valign="top"><?php $this -> load-> view('rpt_raw_data/report_raw_data_filter');?></td>
		</tr>
	</table>
</div>
</fieldset>