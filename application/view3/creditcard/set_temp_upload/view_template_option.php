...
<?php echo form()->legend(lang("Create Template"),"fa-pencil");?>
	<div class="ui-widget-form-table-compact">
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-row">
				<div class="ui-widget-form-cell text_caption">Column</div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell" > <?php echo form()->input('jumlah_column','input_text superlong',NULL,null);?></div>
			</div>
			...
			<div class="ui-widget-form-row">
				<div class="ui-widget-form-cell text_caption">Class Handler</div>
				<div class="ui-widget-form-cell text_caption center">:</div>
				<div class="ui-widget-form-cell" ><?php echo form() -> input('calass_handler','input_text superlong',NULL,NULL);?></div>
			</div>
