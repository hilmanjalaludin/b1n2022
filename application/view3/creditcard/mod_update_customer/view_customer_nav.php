...
var Role = new Ext.Role("UpdateCustomer");
	Role.extend([
...
Ext.DOM.datas =  {
	UPD1_filter_field	: "<?php printf( '%s', get_cokie_exist('UPD1_filter_field'));	?>",
	UPD1_filter_value	: "<?php printf( '%s', get_cokie_exist('UPD1_filter_value'));	?>",
	UPD2_filter_field	: "<?php printf( '%s', get_cokie_exist('UPD2_filter_field'));	?>",
	UPD2_filter_value	: "<?php printf( '%s', get_cokie_exist('UPD2_filter_value'));	?>",
	UPD_call_start_date	: "<?php printf( '%s', get_cokie_exist('UPD_call_start_date'));	?>",
	UPD_call_end_date	: "<?php printf( '%s', get_cokie_exist('UPD_call_end_date'));	?>",
	UPD_call_category	: "<?php printf( '%s', get_cokie_exist('UPD_call_category'));	?>",
	UPD_user_agent		: "<?php printf( '%s', get_cokie_exist('UPD_user_agent'));		?>",
	UPD_last_category	: "<?php printf( '%s', get_cokie_exist('UPD_last_category'));	?>",
 ...
 <form name="FrmCustomerCall">
	<div class="ui-widget-form-table-compact">
		<div class="ui-widget-form-row baris-1">
			...
			<div class="ui-widget-form-cell text_caption left"> <?php echo form()->field("UPD1", "input_text middle", "UpdateFollowup", null);?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('DM_CallCategoryKode'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form()->combo('UPD_call_category','select tolong', AllCallStatus(), _get_exist_session('UPD_call_category'));?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang('DM_SellerId');?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell left"><?php echo form()->combo('UPD_user_agent','select tolong',User(), _get_exist_session('UPD_user_agent'));?></div>
		</div>
		...
		<div class="ui-widget-form-row baris-2">
			...
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('LB_Global_SearchBy'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"> <?php echo form()->field("UPD2", "input_text middle", "UpdateFollowup", null);?></div>
			
			<div class="ui-widget-form-cell text_caption"><?php echo lang(array('DM_LastCategoryKode'));?></div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell text_caption left"><?php echo form()->combo('UPD_last_category','select tolong', AllCallStatus(), _get_exist_session('UPD_last_category'));?></div>
			...
			<div class="ui-widget-form-cell left"> <?php echo form()->interval("UPD_call", "input_text date","UPD_call"); ?></div>
		</div>
