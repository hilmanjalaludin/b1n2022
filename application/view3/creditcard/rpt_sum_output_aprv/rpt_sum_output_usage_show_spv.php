	...
	<table>
		...
		?>
			<tr>
				...
				<td class="kanan"><?php echo ($Data[$array]['TotalUsage']?$Data[$array]['TotalUsage']:0); ?></td>
				<td class="kanan"><?php echo ($Data[$array]['Amount']?$Data[$array]['Amount']:0); ?></td>
			</tr>
		<?php
					$no++;
					
					$sumJumlah		+= $Data[$array]['TotalUsage'];
