...
<?php echo form()->legend(lang("Compose"),$EventIconic);?>
<form name="frmComposer">
	<table border=0 style="margin:15px;width:75%;">
		...
		<tr>
			...
			<td class="text_caption">:</td>
			<td><?php echo form()->input("mail_subject", "input_text", null, null, array("style" => "width:99%;")); ?></td>
		</tr>
		
		<tr>
			<td class="text_caption left" width="10%" nowrap><?php echo lang(array("Content")); ?></td>
			<td class="text_caption">:</td>
			<td class="text_caption left"> <textarea id="content_email_body" name="input"></textarea> </td>
