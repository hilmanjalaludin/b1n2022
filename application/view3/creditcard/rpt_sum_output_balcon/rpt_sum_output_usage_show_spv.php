	...
	<table>
		...
		?>
			<tr>
				...
				<td class="kanan"><?php echo ($Data[$array]['TotalBalcon']?$Data[$array]['TotalBalcon']:0); ?></td>
				<td class="kanan"><?php echo number_format($Data[$array]['Amount']?$Data[$array]['Amount']:0); ?></td>
			</tr>
		<?php
					$no++;
