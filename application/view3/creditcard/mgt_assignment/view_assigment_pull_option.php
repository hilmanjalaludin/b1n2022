...
<fieldset class="corner ui-fieldset-pull-bottom" style="width:auto;margin:5px; ">
<?php echo form()->legend(lang(array("Option","Pull The Data")),"fa-gear");?>
	...
	<div class="ui-widget-form-table-compact">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("pull_user_type", "select xselect tolong", DistribusiType(), null);?></div>
		</div>
		
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"><?php echo lang("Pull. To Group");?></div>
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("pull_to_user_group", "select xselect tolong", PullDataLevelUser(), null, array("change" => "Ext.DOM.SelectUserToByGroup(this);") );?></div>
		</div>
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("pull_user_mode", "select xselect tolong", DitributeMode(),1);?></div>
		</div>

		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption"></div>
			<div class="ui-widget-form-cell text_caption center"></div>
			<div class="ui-widget-form-cell" id="ui-widget-image-loadings"></div>
		</div>
