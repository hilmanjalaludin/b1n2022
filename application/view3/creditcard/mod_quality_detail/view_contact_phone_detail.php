 ...
 <?php echo form()->hidden("CallingNumber",NULL, $Detail->get_value('CustomerMobilePhoneNum')); ?>
	...
	<div class="ui-widget-form-table-compact">
		<div class="ui-widget-form-row">
			...
			<?php echo form()->combo('PhoneNumber','select tolong select-chosen after-user-sale', 
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell center ui-row-col2">:</div>
			<div class="ui-widget-form-cell ui-row-col3">
				<span id="ui-add-phone-list"><?php echo form()->combo('AddPhoneNumber','select tolong select-chosen after-user-sale',
													 $Detail->field('DM_Id', array('CustomerAdditionalPhone')), 
													 $Detail->field('DM_Id', array('CustomerContactLasted','base64_encode')),
													 array("change" =>"Ext.Cmp('CallingNumber').setValue(this.value);")); ?></span>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell left ui-row-col3">
				...
				<?php echo form()->button_role('_ADD_TOOL_',$Button);?>
			</div>
		</div>
 ...
 <fieldset class="corner" style="margin-top:20px;border-radius:0px;padding:22px 0px 10px 0px;">
	...
	<div style="overflow:auto;margin-top:-5px;" class="ui-widget-form-table-compact">		
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center ui-row-col2">:</div>
			<div class="ui-widget-form-cell ui-row-col3"><?php echo form()->combo('CallStatusId','select tolong select-chosen after-user-sale', CallStatusDisposition(), $Detail->field('DM_QualityCategoryId'),array('change'=>"window.EventCallResultID(this);")); ?></div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<?php echo form()->combo('CallResultId','select tolong select-chosen after-user-sale',CallResultByCategory( $Detail->field('DM_QualityCategoryId')), $Detail->field('DM_QualityReasonId'),array('change'=>'getEventSale(this);')); ?> </div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center ui-row-col2">:</div>
			<div class="ui-widget-form-cell ui-row-col3">
				<?php echo form()->input('DateLater','input_text box date after-user-sale'); ?>&nbsp;
				<?php echo form()->combo('HourLater','select boox select-chosen after-user-sale',ListHour(), '00', null,array('style'=>'margin-top:2px;')); ?> :
				<?php echo form()->combo('MinuteLater','select boox select-chosen after-user-sale',ListMinute(),'00', null, array('style'=>'margin-top:2px;'));?>
			</div>
		</div>
		...
		<div class="ui-widget-form-row baris1">
			...
			<div class="ui-widget-form-cell center ui-row-col2">:</div>
			<div class="ui-widget-form-cell ui-row-col3"><?php echo form()->textarea("CallRemarks", "textarea tolong uppercase after-user-sale", null, null );?></div>
		</div>
