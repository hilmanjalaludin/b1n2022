<div class="ui-widget-form-table" style="margin-top:-5px;">
		...
		<div class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell text_caption">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo("frmrek_from_callstatus", "select xselect tolong", AllCallStatus(), null, array('change' =>'window.UnderCallStatus(this);' ) );?></div>
		</div>
