...
<div id="ui-widget-add-campaign" class="tabs corner ui-frame-with">
	<ul>
		<li class="ui-tab-li-lasted">
			...
			<span class="ui-icon ui-icon-plus"></span><?php echo lang("Add Category");?> </a>
		</li>
	</ul>	
	...
	<div id="ui-widget-add-content" class="ui-widget-add-content ui-frame-with">
		...
		<form name="frmAddCategory">
			...
			<tr>
				...
				<td><?php echo form() -> combo('CallOutboundGoalsId','select superlong',$CallType);?></td>
			</tr>
			<tr>
				<td class="text_caption">* Interest</td>
				<td class="text_caption">:</td>
				<td><?php echo form() -> combo('CallReasonInterest','select superlong',$Interest);?></td>
			</tr>
			<tr>
