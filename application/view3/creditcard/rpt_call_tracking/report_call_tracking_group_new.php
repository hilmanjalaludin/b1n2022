...
<?php echo form()->legend(lang(array("Filter","Of", "Report")),"fa-file-text-o");?>
 ...
 <form name="frmReportNew">
	<div class="ui-widget-form-table-compact">
		
		<div class="ui-widget-form-row">
			<div class="ui-widget-form-cell text_caption">Report Type</div>
			<div class="ui-widget-form-cell text_caption center">:</div>
			<div class="ui-widget-form-cell"><?php echo form()->combo('report_type_new','select auto', $report_type_new, null, array("change" => "ShowFilterReportNew(this);"));?></div>
		</div>
		...
		<div id="ui-widget-row-new" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row0-new">
				<?php
					echo form()->chooseall('CampaignIdNew','select tolong',  $report_campaign, null, array("change" => "ShowFilterProduct(this);"));
				?>
			</div>
		</div>
		...
		<div id="ui-widget-row1" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row1">
				<?php echo form()->combo('ManagerIdNew','select tolong',$report_atm, 
		...
		<div id="ui-widget-row3" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row-spv"><?php echo form()->combo('spvidnew','select tolong', $report_spv, $report_user->get_value('tl_id'),
		...
		<div id="ui-widget-row4" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row-tmr"><?php echo form()->combo('TmrIdNew','select tolong', $report_agent);?></div>
		</div>
		...
		<div id="ui-widget-row5" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row5"> <?php echo form()->input('new_start_date','input_text box date');?> &nbsp- <?php echo form()->input('new_end_date','input_text box date');?></div>
		...
		<div id="ui-widget-row6" class="ui-widget-form-row">
			...
			<div class="ui-widget-form-cell" id="ui-widget-content-row6"><?php echo form()->combo('intervalNew','select auto', $report_mode);?></div>
		</div>
		...
		<div id="ui-widget-row7" class="ui-widget-form-row">
			...
			<?php echo form()->button_role( '_XLS_TOOL_', $report_button);*/?>
				...
				<?php echo form()->button('','page-go button','Show',array("click"=>"new ShowReportNew();"));?>
					<?php echo form()->button('','excel button','Export',array("click"=>"new ShowExcelNew();"));?>
