...
var datas =  {
	...
	qty_start_date  :'<?php echo _get_exist_session('qty_start_date');?>', 
	qty_end_date    :'<?php echo _get_exist_session('qty_end_date');?>', 
...
<div class="ui-widget-form-table-compact">
	<div class="ui-widget-form-row baris-1">
		...
		<div class="ui-widget-form-cell left"> <?php echo form()->combo('qty_campaign_id','select long',$Combo['Campaign'],_get_exist_session('qty_campaign_id'));?></div>
	...
	<div class="ui-widget-form-row baris-2">
		...
		<div class="ui-widget-form-cell text_caption center">:</div>
		<div class="ui-widget-form-cell left"> <?php echo form()->combo('qty_user_id','select long',$UserState,_get_exist_session('qty_user_id'));?></div>
		
	</div>
	<div class="ui-widget-form-row baris-3">
		<div class="ui-widget-form-cell text_caption"> Interval </div>
		<div class="ui-widget-form-cell text_caption center">:</div>
		<div class="ui-widget-form-cell left">  <?php echo form()->input('qty_start_date','input_text date',_get_exist_session('qty_start_date'));?> <?php echo form()->input('qty_end_date','input_text date',_get_exist_session('qty_end_date'));?> </div>
